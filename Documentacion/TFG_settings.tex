...
\newcommand{\myName}{Nombre Apellido}
\newcommand{\myFirstSupervisor}{Nombre1 Apellido1}
\newcommand{\mySecondSupervisor}{Nombre2 Apellido2}
\newcommand{\myStudies}{Grado en Ingeniería Informática de Gestión y Sistemas de Información}
