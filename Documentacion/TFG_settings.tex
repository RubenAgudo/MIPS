...
\newcommand{\myTitle}{Aquí va el título del Trabajo Fin de Grado}
\newcommand{\myName}{Rub'en Agudo Santos}
\newcommand{\myFirstSupervisor}{Mikel Villama~ne Giron'es}
\newcommand{\myStudies}{Grado en Ingeniería Inform'atica de Gesti'on y Sistemas de Informaci'on}
\newcommand{\mySchool}{EUITI-Bilbao}
\newcommand{\mySchoolLong}{Escuela Universitaria en Ingeniería Técnica Industrial de Bilbao}
\newcommand{\myUniversity}{UPV-EHU}
\newcommand{\myUniversityURL}{\url{http://www.ehu.es}}
\newcommand{\myTime}{06/07/2013}
...
\DeclareRobustCommand*{\biblatex}{\textsc{Bib}\TeX%
...
\graphicspath{{Logos/}{figs/}} % se pueden poner todos los directorios que incluyan figuras pero no es necesario
